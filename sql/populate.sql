...
-- Tiers
INSERT INTO
    Tier (tier_name, cost, message_limit, pro_access)
VALUES
    ('Free', 0, 100, 'N');
...
INSERT INTO
    Tier (tier_name, cost, message_limit, pro_access)
VALUES
    ('Enterprise', 100, 99999, 'Y');

-- SupportAgents
INSERT INTO
    SupportAgent (name, email, specialty, hired_date)
VALUES
    (
        'Alice Tran',
        'alice@support.llm',
...
-- Users
INSERT INTO
    LLMUser (tier_id, name, email, creation_date, language)
VALUES
    (
        1,
        'Carol Smith',
...
INSERT INTO
    BillingRecord (user_id, payment_method, billing_address)
VALUES
    (1, 'Credit Card', '100 Maple St, Tucson AZ');

INSERT INTO
    BillingRecord (user_id, payment_method, billing_address)
VALUES
    (2, 'PayPal', '200 Oak Ave, Tucson AZ');

INSERT INTO
    BillingRecord (user_id, payment_method, billing_address)
VALUES
    (3, 'Credit Card', '10 Elm Rd, Berlin');

INSERT INTO
    BillingRecord (user_id, payment_method, billing_address)
VALUES
    (4, 'Bank Transfer', '300 Pine St, Seattle WA');

INSERT INTO
    BillingRecord (user_id, payment_method, billing_address)
VALUES
    (5, 'Credit Card', '50 Han River Dr, Seoul');

INSERT INTO
    BillingRecord (user_id, payment_method, billing_address)
VALUES
    (6, 'Credit Card', '1-1 Shibuya, Tokyo');
...
VALUES
    (3, 2, DATE '2024-03-01', 20.00, 'Paid');
...
VALUES
    (3, 2, DATE '2024-04-01', 20.00, 'Unpaid');
...
VALUES
    (4, 2, DATE '2024-04-01', 20.00, 'Paid');
...
VALUES
    (5, 3, DATE '2024-05-01', 100.00, 'Unpaid');
...
VALUES
    (6, 3, DATE '2024-06-01', 100.00, 'Paid');

-- Workspaces
INSERT INTO
    Workspace (owner_id, name, visibility, created_at)
VALUES
    (
        3,
        'Eva Research Hub',
...
VALUES
    (1, 3, 'OWNER', TIMESTAMP '2024-03-10 09:00:00');

INSERT INTO
    WorkspaceMember (workspace_id, user_id, role, joined_at)
VALUES
    (1, 4, 'MEMBER', TIMESTAMP '2024-03-15 11:00:00');

INSERT INTO
    WorkspaceMember (workspace_id, user_id, role, joined_at)
VALUES
    (2, 5, 'OWNER', TIMESTAMP '2024-05-05 10:00:00');

INSERT INTO
    WorkspaceMember (workspace_id, user_id, role, joined_at)
VALUES
    (2, 6, 'MEMBER', TIMESTAMP '2024-05-06 08:00:00');

-- Personas
INSERT INTO
    Persona (owner_user_id, name, instructions, created_at)
VALUES
    (
        3,
        'Senior Architect',
...
INSERT INTO
    Message (conversation_id, sender_role, time_sent, content)
VALUES
    (
        1,
        'USER',
        TIMESTAMP '2024-04-01 10:01:00',
...
VALUES
    (
        4,
        'USER',
        TIMESTAMP '2024-06-01 08:01:00',
        'How to read CSVs in pandas?'
    );
...
VALUES
    (
        5,
        'USER',
        TIMESTAMP '2024-06-25 14:01:00',
        'Give me an opening line for a sci-fi story.'
    );
...
VALUES
    (
        6,
        'AI',
        TIMESTAMP '2024-07-01 12:01:10',
        'Hello! How can I help you today?'
    );

-- MessageFeedback
INSERT INTO
    MessageFeedback (message_id, rating, comment_text, submitted_at)
VALUES
    (
        2,
        'Thumbs Up',
        'Very clear trade-off summary.',
        TIMESTAMP '2024-04-01 10:05:00'
    );
...
VALUES
    (
        4,
        'Thumbs Up',
        'Good pointer on Kubernetes.',
        TIMESTAMP '2024-04-01 10:07:00'
    );
...
VALUES
    (
        ...
        'Thumbs Up',
        'Love this opening!',
        TIMESTAMP '2024-06-25 14:03:00'
    );

-- MessageBookmarks (user 1 bookmarks messages from conv 1 and conv 5)
INSERT INTO
    MessageBookmark (user_id, message_id, bookmarked_time)
VALUES
    (1, 2, TIMESTAMP '2024-04-02 08:00:00');

INSERT INTO
    MessageBookmark (user_id, message_id, bookmarked_time)
VALUES
    (1, 12, TIMESTAMP '2024-06-26 09:00:00');

-- user 3 bookmarks from conv 2
INSERT INTO
    MessageBookmark (user_id, message_id, bookmarked_time)
VALUES
    (3, 6, TIMESTAMP '2024-04-06 10:00:00');
...
INSERT INTO
    WorkspacePromptTemplate (workspace_id, template_id, shared_at)
VALUES
    (1, 1, TIMESTAMP '2024-04-11 08:00:00');

INSERT INTO
    WorkspacePromptTemplate (workspace_id, template_id, shared_at)
VALUES
    (2, 3, TIMESTAMP '2024-06-23 09:00:00');
